...
const getAllPostAX = () => {
  return function (dispatch){
      ...
      axios.get(`${config.api}/calendars`)
      .then((response) => {
...
const getOnePostAX = (selectedAt) => {
  return function (dispatch){
      ...
      axios.get(`${config.api}/cards/${selectedAt}`)
      .then((response) => {
...
const addPostAX = (post) => {
  ...
  return function (dispatch){
      ...
      axios.post(`${config.api}/cards`,data)
      .then((response) => {
        console.log(response)
...
const editPostAX = (post) => {
  return function (dispatch){
    ...
    axios.put(`${config.api}/cards/${post.selectedAt}`, data)
      .then((response) => {
        console.log(response)
...
const removePostAX = (selectedAt) => {
  return function (dispatch){
    axios.delete(`${config.api}/cards/${selectedAt}`)
      .then((reponse) => { 
...
export default handleActions(
  {
    ...
    [LOADDAILY]: (state, action) => produce(state, (draft) => {
